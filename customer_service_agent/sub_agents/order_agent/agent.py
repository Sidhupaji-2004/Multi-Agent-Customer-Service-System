...
def refund_course(tool_context: ToolContext): 
    """_summary_
        Simulates the refunding by the AI Couse Selling Platform. 
    Args:
...
order_agent = Agent(
    ...
    Your Rs. 479 will be returned to your original payment method within 3-5 business days.
