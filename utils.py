...
def update_interaction_history(session_service, app_name, user_id, session_id, entry): 
    """
        ...
        Args: 
            ...
            app_name: The application service 
    ...
    try: 
        ...
        interaction_history = session.state.get(
            "interaction_history", 
            []
        )
...
def add_agent_response_to_history(session_service, app_name, user_id, session_id, agent_name, response): 
    ...
    Args:
        session_service (_type_): _description_
...
def display_state(session_service, app_name, user_id, session_id, label="Current State"): 
    ...
    Args:
        session_state (_type_): _description_
        app_name (_type_): _description_
        user_id (_type_): _description_
        session_id (_type_): _description_
        label (str, optional): _description_. Defaults to "Current State".
    """
    try:
        session = session_service.get_session(
            app_name=app_name, user_id=user_id, session_id=session_id
